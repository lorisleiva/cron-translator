...
return [
    ...
    'months' => [
        ...
        'multiple_per_year' => ':count lună a anului',
    ...
    'days_of_week' => [
        ...
        'multiple_days_a_week' => ':count zile ale sătpămânii',
        'once_on_day' => 'în zilele de :days',
    ],
    'years' => [
        'every' => 'în fiecare an',
    ],
